...
export default function ExpressionPage() {
  ...
  const handleCreate = async () => {
    if (!expression.trim()) {
      alert('Please provide your expression')
      return
    }
    ...
    try {
      ...
      const link = `${window.location.origin}/expression/${sessionData.sessionId}`
      setShareLink(link)
    } catch (error) {
          ...
          <Card className="grain-texture">
            <CardHeader>
              ...
              <CardDescription className="text-base">
                Express your true feelings. Share what's in your heart with someone special.
              </CardDescription>
            </CardHeader>
