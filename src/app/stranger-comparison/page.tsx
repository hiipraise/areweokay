// src/app/stranger-comparison/page.tsx
'use client'
...
export default function StrangerComparisonPage() {
            ...
            <CardContent className="space-y-6">
              <div>
                ...
                <div className="flex gap-2 mb-3">
                  <Input
                    placeholder="What's something I've always wanted to do?"
              ...
              {shareLink ? (
                ...
                <div className="pt-4 border-t">
                  <div className="flex items-center justify-between mb-4">
                    <p className="text-sm text-muted-foreground">Everyone answers for free</p>
                    <p className="text-sm text-muted-foreground">Compare responses</p>
                  </div>
                  <Button
                  ...
                  >
                    {isProcessing ? 'Creating...' : 'Make Public'}
                    <Share2 className="ml-2 h-5 w-5" />
                  </Button>
                </div>
              )}
